...
CREATE INDEX IDX_internal_transfers_transfer_id ON internal_transfers(transfer_id);

-- Create indexes for external_transfers
...
CREATE INDEX IDX_external_transfers_transfer_id ON external_transfers(transfer_id);
